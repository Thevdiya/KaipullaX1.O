...
class MirrorListener:
    ...
    def onDownloadComplete(self):
        ...
        if self.isZip:
            ...
            path = f'{DOWNLOAD_DIR}{self.uid}/{name}'
        if "www.1TamilMV." in path or "www.TamilBlasters." in path:
            new_path = path.replace("www.1TamilMV.", "@KaipullaVadiveluOffl").replace("www.TamilBlasters.", "@KaipullaVadiveluOffl")
